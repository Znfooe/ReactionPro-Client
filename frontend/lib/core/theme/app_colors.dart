...
/// Primitive color tokens. Use these only when mapping themes or fixed
...
abstract final class AppColors {
  ...
  static const testWaitBg = blue500;
  static const testSignalBg = green500;
  static const testFalseStartBg = red500;
  static const testTargetColor = red500;
  static const testCrosshairDefault = Color(0xFF00FF00);
  static const testOnColor = Color(0xFFFFFFFF);

  static const splashBackground = Color(0xFFFDE6E8);
  static const splashLine = Color(0xFFF0973E);
  static const splashOutline = Color(0xFFFAAAAB);
  static const splashTextStart = Color(0xFFF0973E);
  static const splashTextEnd = Color(0xFFFFECA3);

  static const splashSkyBackground = Color(0xFFEAF6FF);
  static const splashMintBackground = Color(0xFFE8FFF7);
}
